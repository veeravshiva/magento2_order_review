...
class Cron
{
    ...
    public function __construct(
        ...
        \Magento\Store\Model\StoreManagerInterface $urlHelper
    ) {
    ...
    public function sendOrderReviewEmails()
    {
        foreach ($this->getOrdersToSendEmail() as $order) {
            ...
            $vars = array(
                'name' => $order->getCustomerFirstname(),
                'add_review_link' => $this->urlHelper->getStore()->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_WEB)."reviews/order/addreview?increment_id=$incrementId&token=$token"
            );
